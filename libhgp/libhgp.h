...
typedef void (*CGAL_Image_Grid_Decomposition_C1)(Vector1i2& image, Vector1d2& boundary_xs, Vector1d2& boundary_ys);
typedef void (*CGAL_Image_Grid_Decomposition_Conservative_C1)(Vector1i2& image, Vector1d2& boundary_xs, Vector1d2& boundary_ys);
typedef void (*CGAL_Image_Grid_Decomposition_C2)(Vector1i2& image, Vector2d2& boundaries);
typedef void (*CGAL_Image_Grid_Decomposition_Conservative_C2)(Vector1i2& image, Vector2d2& boundaries);
...
typedef Vector1i2 (*CGAL_2D_Polygon_Triangulation_C2)(const Vector2d2& polys);
typedef Vector1i2 (*CGAL_2D_Polygon_Triangulation_C3)(const Vector2d1& poly);
...
typedef void (*CGAL_3D_Points_Inside_Triangles_C1_Bool)(const Vector3d1& vecs, const Vector1i1& face_id_0, const Vector1i1& face_id_1, const Vector1i1& face_id_2, const Vector3d1& points, Vector1b1& insides);
typedef void (*CGAL_3D_Points_Inside_Triangles_C2_Bool)(const char* path, const Vector3d1& points, Vector1b1& insides);
//d: percentage value of the length of the diagonal of the bounding box.
...
typedef double (*CGAL_3D_Distance_Point_Triangles)(const Vector3d& p, const Vector3d1& vecs, const Vector1i1& face_id_0, const Vector1i1& face_id_1, const Vector1i1& face_id_2);
typedef Vector3d (*CGAL_3D_Nearest_Point_Triangles)(const Vector3d& p, const Vector3d1& vecs, const Vector1i1& face_id_0, const Vector1i1& face_id_1, const Vector1i1& face_id_2);
typedef void (*CGAL_3D_Distance_Point_Mesh)(const char* path, const Vector3d1& query_points, Vector1d1& distances);
typedef void (*CGAL_3D_Neareast_Point_Mesh)(const char* path, const Vector3d1& ves, Vector3d1& ners);
typedef void  (*CGAL_3D_Mesh_Near_Triangles)(const Vector3d1& vecs, const Vector1i1& face_id_0, const Vector1i1& face_id_1, const Vector1i1& face_id_2, const Vector3d1& points, const double& d, Vector1i2& triangles);
typedef void (*CGAL_3D_Points_inside_Triangles_C1)(const Vector3d1& vecs, const Vector1i1& face_id_0, const Vector1i1& face_id_1, const Vector1i1& face_id_2, const Vector3d1& points, Vector1b1& insides);
typedef void (*CGAL_3D_Points_inside_Triangles_C2)(const char* path, const Vector3d1& points, Vector1b1& insides);
typedef void (*CGAL_Mesh_Subdivision)(const char* in_path, const char* sub, const int& step, const char* out_path);
typedef void (*CGAL_Mesh_Loop_Subdivision_One_Step)(Vector3d1& vecs, Vector1i1& face_id_0, Vector1i1& face_id_1, Vector1i1& face_id_2);
typedef void (*CGAL_3D_Mesh_Curvature_C1)(const Vector3d1& vecs, const Vector1i1& face_id_0, const Vector1i1& face_id_1, const Vector1i1& face_id_2, Vector1d1& max_curs, Vector1d1& min_curs);
typedef void (*CGAL_3D_Mesh_Curvature_C2)(const Vector3d1& vecs, const Vector1i2& face_ids, Vector1d1& max_curs, Vector1d1& min_curs);
typedef void (*CGAL_3D_Mesh_Curvature_C3)(const Vector3d1& vecs, const Vector1i1& face_id_0, const Vector1i1& face_id_1, const Vector1i1& face_id_2, Vector1d1& max_curs, Vector1d1& min_curs, Vector3d1& max_curs_directions, Vector3d1& min_curs_directions);
typedef void (*CGAL_3D_Mesh_Curvature_C4)(const Vector3d1& vecs, const Vector1i2& face_ids, Vector1d1& max_curs, Vector1d1& min_curs, Vector3d1& max_curs_directions, Vector3d1& min_curs_directions);
typedef void (*CGAL_3D_Mesh_Curvature_C5)(const Vector3d1& vecs, const Vector1i1& face_id_0, const Vector1i1& face_id_1, const Vector1i1& face_id_2, Vector1d1& max_curs, Vector1d1& min_curs, Vector3d1& max_curs_directions, Vector3d1& min_curs_directions, Vector3d1& normals);
typedef void (*CGAL_3D_Mesh_Curvature_C6)(const Vector3d1& vecs, const Vector1i2& face_ids, Vector1d1& max_curs, Vector1d1& min_curs, Vector3d1& max_curs_directions, Vector3d1& min_curs_directions, Vector3d1& normals);
typedef void (*CGAL_3D_Triangle_Mesh_Boundary_C1)(const Vector3d1& vecs, const Vector1i1& face_id_0, const Vector1i1& face_id_1, const Vector1i1& face_id_2, Vector1b1& bools);
typedef void (*CGAL_3D_Triangle_Mesh_Boundary_C2)(const char* path, Vector1b1& bools);
...
typedef void (*CGAL_3D_Triangle_Mesh_Boundary_C3)(Vector3d1& vecs, Vector1i1& face_id_0, Vector1i1& face_id_1, Vector1i1& face_id_2, Vector3d2& boundaries);
typedef void (*CGAL_3D_Triangle_Mesh_Boundary_C4)(Vector3d1& vecs, Vector1i2& face_ids, Vector3d2& boundaries);
...
typedef void (*CGAL_3D_Triangle_Mesh_Vecs_Neighbors)(Vector3d1& vecs, Vector1i1& face_id_0, Vector1i1& face_id_1, Vector1i1& face_id_2, Vector1i2& neighs);
typedef void (*CGAL_Mesh_Laplace_Smooth_C2)(Vector3d1& vecs, Vector1i1& face_id_0, Vector1i1& face_id_1, Vector1i1& face_id_2, const int laplace_nb);
typedef void (*CGAL_3D_Triangle_Mesh_Vecs_Faces)(Vector3d1& vecs, Vector1i1& face_id_0, Vector1i1& face_id_1, Vector1i1& face_id_2, Vector1i2& surface_vectices_to_face);
typedef void (*CGAL_3D_Triangle_Mesh_Vecs_Neighbor_Edges)(Vector3d1& vecs, Vector1i1& face_id_0, Vector1i1& face_id_1, Vector1i1& face_id_2, Vector1i3& surface_vectices_to_neighbor_edges);
typedef void (*CGAL_Mesh_Laplace_Smooth_by_Curvature)(Vector3d1& vecs, Vector1i1& face_id_0, Vector1i1& face_id_1, Vector1i1& face_id_2, double& low_curvature);
...
typedef void (*CGAL_Slicer_Mesh)(const char* path, const Vector3d& plane_normal, const Vector1d1& plane_d, Vector3d3& offsetses, Vector3d2& offsets);
...
typedef Vector3d1 (*CGAL_Project_Points_Onto_Surface_C1)(const Vector3d1& vecs, const Vector1i1& face_id_0, const Vector1i1& face_id_1, const Vector1i1& face_id_2, const Vector3d1& points);
typedef Vector3d1 (*CGAL_Project_Points_Onto_Surface_C2)(const char* path, const Vector3d1& points);
typedef void (*CGAL_3D_Triangel_Mesh_Most_Inside_Point)(const Vector3d1& vecs, const Vector1i1& face_id_0, const Vector1i1& face_id_1, const Vector1i1& face_id_2, Vector3d& inside);
typedef double (*CGAL_3D_One_Triangle_Area)(const Vector3d& v0, const Vector3d& v1, const Vector3d& v2);
typedef double (*CGAL_3D_Triangle_Mesh_Area)(const Vector3d1& vecs, const Vector1i1& face_id_0, const Vector1i1& face_id_1, const Vector1i1& face_id_2);
typedef void (*CGAL_3D_Convex_Hulls_C1)(const Vector3d1& vec, Vector3d1& hull_points);
typedef void (*CGAL_3D_Convex_Hulls_C2)(const Vector3d1& vec, Vector3d1& hull_points, Vector1i1& hulls_surface_0, Vector1i1& hulls_surface_1, Vector1i1& hulls_surface_2);
typedef void (*CGAL_3D_Convex_Hulls_C3)(const Vector3d1& vec, Vector3d1& hull_points, Vector3d1& plane_p, Vector3d1& plane_n);
typedef void (*CGAL_3D_Convex_Hulls_C4)(const Vector3d1& vec, Vector3d1& hull_points, Vector1i1& hulls_surface_0, Vector1i1& hulls_surface_1, Vector1i1& hulls_surface_2, Vector3d1& plane_p, Vector3d1& plane_n);
...
typedef void (*CGAL_Mesh_Field_Query_C2)(const char* path, const Vector1d1& gradient_values, const Vector3d1& input_points, Vector1d1& points_gradient_values);
typedef void (*CGAL_Mesh_Field_Query_C3)(const char* path, const Vector1d1& gradient_values, const Vector3d2& input_point_es, Vector1d2& points_gradient_value_es);
typedef void (*CGAL_Curvature_Mesh)(const char* path, const Vector3d1& input_points, Vector1d1& max_curs, Vector1d1& min_curs, Vector3d1& max_curs_directions, Vector3d1& min_curs_directions);
...
typedef void (*CGAL_3D_Mesh_Normal_C1)(const Vector3d1& ps, const Vector1i2& face_ids, Vector3d1& normals);
typedef void (*CGAL_3D_Mesh_Normal_C2)(const Vector3d1& ps, const Vector1i1& face_id_0, const Vector1i1& face_id_1, const Vector1i1& face_id_2, Vector3d1& normals);
...
typedef void (*CGAL_Surface_Decomposition)(const char* path, Vector1d1& face_sdf, int& regions_nb, Vector1i1& face_segments);
typedef void (*CGAL_3D_Mesh_Gradient)(const Vector3d1& vecs, const Vector1i1& face_id_0, const Vector1i1& face_id_1, const Vector1i1& face_id_2, const Vector1d1& psd, Vector3d1& vecs_gradients, Vector3d1& faces_gradients);
typedef void (*CGAL_Intergral_Curvature)(const Vector2d1& input_points, const int& sampling_points_nb, const double& radius, const double& thresholder, Vector2d1& output_points, Vector1d1& output_rates);
typedef bool (*CGAL_3D_Mesh_Extract_Isoline)(const Vector3d1& vecs, const Vector1i1& face_id_0, const Vector1i1& face_id_1, const Vector1i1& face_id_2, const Vector1d1& psd, const double& d, Vector3d2& isolines);
